...
class ClientController extends Controller
{
    public function index($search = '') {
        $clients = Client::where('title', 'like', "%$search%")->get();
        $clientCount = count($clients);

        return inertia('Clients/Index', [
            'clients' => fn() => Client::where('title', 'like', "%$search%")->get(),
    ...
    public function update(Client $client, Request $request)
    {
        ...
        return redirect('/clients/' . $client->id)->with('info', 'A new commitment has been updated');
    }


    public function destroy(Client $client) {
        $client->delete();
        return redirect('/clients')->with('error', 'A new commitment has been deleted');
    }
    ...
    public function store(Request $request) {
        ...
        return redirect('/clients/' . $c->id)->with('info', 'A new commitment has been created');
    }
